"""cryptonite_24711 URL Configuration
...
admin.site.site_header = "Cryptonite"
admin.site.site_title = "Cryptonite Admin Portal"
admin.site.index_title = "Cryptonite Admin"

# swagger
api_info = openapi.Info(
    title="Cryptonite API",
    default_version="v1",
    description="API documentation for Cryptonite App",
)
